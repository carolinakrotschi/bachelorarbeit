...
where \(d\) is the displacement of the moving mirror on the translation stage, \(\lambda\) is the laser wavelength, and \(\Delta\phi\) is the measured phase change \prismcite{32}.
...
A wire-grid polarizer (shown in Figure~\ref{fig:wire_grid_polarizer}) consists of many parallel conducting wires. When light reaches the grid, its electric field can be decomposed into a component parallel to the wires and a component perpendicular to the wires \prismcite{38}. The electric field component parallel to the wires drives the free electrons in the metal along the wire direction. The resulting oscillating currents reradiate electromagnetic waves, leading mainly to reflection and absorption of this polarization component.
...
\begin{figure}[htbp]
    ...
    \caption{Principle of a wire-grid polarizer. The electric field component parallel to the conducting wires is mostly reflected or absorbed, while the perpendicular component is transmitted. Obtained from \prismcite{38}.}
