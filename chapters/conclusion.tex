...
The camera-based detection was less affected by environmental noise. This is likely because the camera averages the signal over its exposure time, whereas the photodiode picks up more high-frequency noise due to its higher sampling rate. The homodyne quadrature interferometer successfully demonstrated the feasibility of direction-sensitive displacement measurements. However, since the quadrature setup relies on two photodiodes, whose signals were affected by fluctuations and noise, the camera-based detection method is expected to provide more reliable results for future measurements.
